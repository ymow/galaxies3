...
role :web, "galaxies3.com"                          # Your HTTP server, Apache/etc
role :app, "galaxies3.com"                         # This may be the same as your `Web` server
role :db,  "galaxies3.com"   , :primary => true # This is where Rails migrations will run
